...
namespace J3P2_Monogame_Project.monoPong
{
    class MainMenu : Scene
    {
        ...
        public override void LoadContent(SceneManager sceneManager)
        {
            ...
            PlayButton _playButton = new PlayButton(new Vector2(-50), _graphics.GraphicsDevice, _rectangle, sceneManager);
            QuitButton _quitButton = new QuitButton(new Vector2(50), _graphics.GraphicsDevice, _rectangle, sceneManager);
